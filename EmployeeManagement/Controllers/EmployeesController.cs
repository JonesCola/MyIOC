...
namespace EmployeeManagement.Controllers
{
  public class EmployeesController : Controller
  {
    ...
    public ActionResult Create([Bind(Include = "ID,FullName,Number,StartDate")] Employee employee)
    {
    ...
    [HttpPost]
    [ValidateAntiForgeryToken]
    public ActionResult Edit([Bind(Include = "ID,FullName,Number,StartDate")] Employee employee)
    {
      if (ModelState.IsValid)
      {
